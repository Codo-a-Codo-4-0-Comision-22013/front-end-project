		...
		<Box my={5}>
			...
			<Container sx={{ my: 3 }}>
				<Stack direction="row" spacing={5}>
					<Typography variant="subtitle2">Términos de servicio</Typography>
					<Typography variant="subtitle2">Portal de Protección de Datos de la FIFA</Typography>
					<Typography variant="subtitle2">Descárgalo</Typography>
				</Stack>
				<Typography fontWeight="bold" my={1} display="block" variant="caption">Copyright © 1994 - 2022 FIFA. Reservados todos los derechos.</Typography>
				<Typography fontWeight="bold" display="block" variant="caption">Configuración de cookies</Typography>
			</Container>
		</Box>
	)
}
