...
const Footer = () => {
    return (
        <footer className="bg-gray-900">
            <div className="grid grid-cols-2 gap-8 py-6 px-4 md:grid-cols-4">
                <div>
                    ...
                    <ul className="text-gray-300">
                        ...
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Press Site</a>
                        </li>
                        <li className="mb-4">
                ...
                <div>
                    ...
                    <ul className="text-gray-300">
                        ...
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Player Guidelines</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-300">
                        ...
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Safety FAQs</a>
                        </li>
            ...
            <div className="py-4 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-base text-gray-300 sm:text-center">© 2022 <a href="https://Pokedex.com/"><b>PokéDex™</b></a>. All Rights Reserved.
                </span>
